...
import { MapPin, Download } from "lucide-react"; // Mantener Download
    ...
    <section className="mt-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        {(currentUser?.role === "admin" || currentUser?.role === "deposito") && (
          <button
            onClick={onExportCSV}
            className="rounded-xl border border-neutral-200 px-3 py-2 text-sm hover:bg-neutral-50 flex items-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 gap-3">
          {orders.map((o) => (
            <div key={o.id} className="rounded-2xl border border-neutral-200 bg-white p-4">
              ...
              {/* ... (Detalles Cliente, Fecha, Total - sin cambios) ... */}
              ...
              {/* ... (Dirección de Envío - sin cambios) ... */}
              ...
              {/* ... (Tabla de Items del Pedido - sin cambios) ... */}
              ...
              <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
                ...
                {/* --- MODIFICACIÓN: Añadir condición para mostrar PrintOrderButton --- */}
                <div className="flex items-center gap-2">
                  {currentUser?.role !== 'cliente' && ( // <-- Solo muestra si NO es cliente
